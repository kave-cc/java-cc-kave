...
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.METHOD2;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.PARAM1;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.PARAM1_ARGNUM;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.PARAM2;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.PARAM2_ARGNUM;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.SUPERCLASS1;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.SUPERCLASS2;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.TYPE;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.assertBooleanNode;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.assertNodeExists;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.assertNodesExist;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.assertProbabilities;
import static cc.kave.rsse.calls.recs.pbn.PBNModelBuilderFixture.assertStates;
...
public class PBNModelBuilderTest {
	...
	public void dummyStatesAreAddedToDictionary() {
		...
		assertTrue(dictionary.contains(new ClassContextFeature(PBNModelConstants.DUMMY_TYPE)));
		assertTrue(dictionary.contains(new MethodContextFeature(PBNModelConstants.DUMMY_METHOD)));
