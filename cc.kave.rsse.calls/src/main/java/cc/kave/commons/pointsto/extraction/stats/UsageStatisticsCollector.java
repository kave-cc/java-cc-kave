...
public interface UsageStatisticsCollector {
	...
	/**
	 * Creates a new {@link UsageStatisticsCollector} instance of the implementing
	 * class.
	 */
	UsageStatisticsCollector create();

	/**
	 * Merges the state of the given {@link UsageStatisticsCollector} into this
	 * instance. Only guaranteed to work if this and the other instance are of the
	 * same class.
	 */
