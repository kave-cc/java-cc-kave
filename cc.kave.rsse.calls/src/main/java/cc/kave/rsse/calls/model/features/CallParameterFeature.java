...
public class CallParameterFeature implements IFeature {
	...
	public CallParameterFeature(ICallParameter callParameter) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + callParameter.hashCode();
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CallParameterFeature other = (CallParameterFeature) obj;
		if (!callParameter.equals(other.callParameter))
			return false;
		return true;
	}
