...
public class DefinitionSite {
	...
	public String toString() {
		if (kind == null) {
			return "INVALID";// "Invalid" + ToStringUtils.toString(this);
		}

		boolean isFieldMissing = kind == DefinitionSiteKind.FIELD && field == null;
		boolean isPropertyMissing = kind == DefinitionSiteKind.PROPERTY && property == null;
		...
		if (isFieldMissing || isPropertyMissing || isMethodMissing) {
			return "INVALID";// "Invalid" + ToStringUtils.toString(this);
		}
