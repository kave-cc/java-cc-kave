...
// (generated at: 1/14/2018 11:26:14 PM)
// ##############################################################################
/**
...
public class GeneratedTypeNameTest {
/*
 * default value tests
 */
@Test
...
hasThrown = false;
try { sut.asArrayTypeName(); } catch(AssertionException e) { hasThrown = true; }
assertTrue(hasThrown);
// delegates
assertFalse(sut.isDelegateType());
hasThrown = false;
try { sut.asDelegateTypeName(); } catch(AssertionException e) { hasThrown = true; }
assertTrue(hasThrown);
// predefined
assertFalse(sut.isPredefined());
hasThrown = false;
try { sut.asPredefinedTypeName(); } catch(AssertionException e) { hasThrown = true; }
assertTrue(hasThrown);
// type parameters
assertFalse(sut.isTypeParameter());
hasThrown = false;
try { sut.asTypeParameterName(); } catch(AssertionException e) { hasThrown = true; }
assertTrue(hasThrown);
}
@Test
...
String baseId = "n.T, A, 1.2.3.4";
String arr1Id = "n.T[], A, 1.2.3.4";
String arr2Id = "n.T[,], A, 1.2.3.4";
ITypeName base = TypeUtils.createTypeName(baseId);
ITypeName arr1 = ArrayTypeName.from(base, 1);
assertTrue(arr1 instanceof ArrayTypeName);
assertEquals(arr1Id, arr1.getIdentifier());
...
assertFalse(sut.isUnknown());
assertEquals(new NamespaceName("n"), sut.getNamespace());
assertEquals(new AssemblyName("A, 1.2.3.4"), sut.getAssembly());
assertEquals("n.T", sut.getFullName());
assertEquals("T", sut.getName());
assertTrue(sut.isClassType());
assertFalse(sut.isEnumType());
...
IArrayTypeName sutArr = sut.asArrayTypeName();
assertEquals(1, sutArr.getRank());
assertEquals(new TypeName("n.T, A, 1.2.3.4"), sutArr.getArrayBaseType());
// delegates
assertFalse(sut.isDelegateType());
hasThrown = false;
try { sut.asDelegateTypeName(); } catch(AssertionException e) { hasThrown = true; }
