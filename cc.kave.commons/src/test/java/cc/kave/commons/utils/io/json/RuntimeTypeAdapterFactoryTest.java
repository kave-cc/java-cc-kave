...
public final class RuntimeTypeAdapterFactoryTest extends TestCase {
  ...
  public void testRuntimeTypeAdapter() {
    ...
    assertEquals("{\"type\":\"cc.kave.commons.utils.io.json.RuntimeTypeAdapterFactoryTest$CreditCard\",\"cvv\":234,\"ownerName\":\"Jesse\"}",
        gson.toJson(original, BillingInstrument.class));
    BillingInstrument deserialized = gson.fromJson(
        "{type:'cc.kave.commons.utils.io.json.RuntimeTypeAdapterFactoryTest$CreditCard',cvv:234,ownerName:'Jesse'}", BillingInstrument.class);
  ...
  public void testRuntimeTypeIsBaseType() {
    ...
    assertEquals("{\"type\":\"cc.kave.commons.utils.io.json.RuntimeTypeAdapterFactoryTest$BillingInstrument\",\"ownerName\":\"Jesse\"}",
        gson.toJson(original, BillingInstrument.class));
    BillingInstrument deserialized = gson.fromJson(
        "{type:'cc.kave.commons.utils.io.json.RuntimeTypeAdapterFactoryTest$BillingInstrument',ownerName:'Jesse'}", BillingInstrument.class);
    assertEquals("Jesse", deserialized.ownerName);
  }
